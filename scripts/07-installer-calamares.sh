...
sudo mkdir -p "${CALAMARES_TARGET}/branding/apexos"
...
sudo cp "${ROOT_DIR}/config/calamares/branding/apexos/branding.desc" "${CALAMARES_TARGET}/branding/apexos/branding.desc"
